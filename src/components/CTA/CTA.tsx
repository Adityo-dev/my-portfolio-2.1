    ...
    <section className="relative w-full bg-background border-t border-white/5 py-24 overflow-hidden">
      <div className="mx-auto max-w-[1400px] px-4 relative z-10 flex justify-center">
        ...
        <motion.div 
          ...
          className="w-full max-w-5xl rounded-md border border-white/10 bg-white/[0.02] p-12 md:p-20 flex flex-col items-center text-center gap-6 md:gap-8 relative overflow-hidden"
        >
